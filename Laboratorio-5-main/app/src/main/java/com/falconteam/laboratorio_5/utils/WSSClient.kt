package com.falconteam.laboratorio_5.utilsx
...
class WSSClient(serverUri: URI, private val viewModel: BlogsitoViewModel) :
    ...
    override fun onClose(code: Int, reason: String?, remote: Boolean) {
        ...
        viewModel.websocketConnectionClosed(
            webSocketErrorDescriptions[code]
                ?: "La aplicación a presentado un fallo reportarlo a support@infoking.win",
            webSocketErrorCodes[code] ?: "Error interno en la aplicación",
            remote
        )
    }
