...
import com.falconteam.laboratorio_5.data.database.Element
...
import com.falconteam.laboratorio_5.remote.RepositoryProvider
...
import com.falconteam.laboratorio_5.utilsx.WSSClient
...
class BlogsitoViewModel : ViewModel() {
    ...
    private fun GetAllPostWithCommentsResponse.toPostEntity() : Post {
        return Post(_id, tittle, description, author, messages)
    }
